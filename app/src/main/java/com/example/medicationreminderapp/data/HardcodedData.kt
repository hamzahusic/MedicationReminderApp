...
val todayHistory = listOf<Medication>(
    Medication(1, "Paracetamol", "500mg", 8, 2, isTaken = true, takenAtHour = 8, takenAtMinute = 0),
    Medication(2, "Ibuprofen", "400mg", 14, 2),
    Medication(3, "Ibuprofen", "400mg", 18, 0),
)

var medications = listOf<Medication>(
    Medication(1, "Paracetamol", "500mg", 14, 0, isTaken = true, takenAtHour = 14, takenAtMinute = 0),
